...
const copy = {
  en: {
    ...
    orderModalTitle: "Delivery Details",
    orderFormName: "Full Name",
    orderFormEmail: "Email",
    orderFormPhone: "Phone (optional)",
    orderFormStreet: "Street & Number",
    orderFormCity: "City",
    orderFormPostcode: "Postcode",
    orderFormCountry: "Country",
    orderFormCountryDE: "Germany",
    orderFormCountryAT: "Austria",
    orderFormCountryCH: "Switzerland",
    orderFormCountryGB: "United Kingdom",
    orderFormCountryNL: "Netherlands",
    orderFormSubmit: "Continue to Payment",
    orderFormClose: "Close",
    orderFormError: "Something went wrong. Please try again.",
    orderFormRequired: "Please fill in all required fields.",
    orderFormLoading: "Please wait…",
  },
  ...
  de: {
    ...
    orderModalTitle: "Lieferadresse",
    orderFormName: "Vollständiger Name",
    orderFormEmail: "E-Mail",
    orderFormPhone: "Telefon (optional)",
    orderFormStreet: "Straße & Hausnummer",
    orderFormCity: "Stadt",
    orderFormPostcode: "Postleitzahl",
    orderFormCountry: "Land",
    orderFormCountryDE: "Deutschland",
    orderFormCountryAT: "Österreich",
    orderFormCountryCH: "Schweiz",
    orderFormCountryGB: "Vereinigtes Königreich",
    orderFormCountryNL: "Niederlande",
    orderFormSubmit: "Weiter zur Zahlung",
    orderFormClose: "Schließen",
    orderFormError: "Etwas ist schiefgelaufen. Bitte nochmals versuchen.",
    orderFormRequired: "Bitte alle Pflichtfelder ausfüllen.",
    orderFormLoading: "Bitte warten…",
  },
} as const;
