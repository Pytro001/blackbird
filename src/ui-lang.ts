...
const copy = {
  en: {
    ...
    subscriptionPriceFrequency: "/ 6 weeks",
    subscriptionRefillCopy: "We send your refill automatically every 6 weeks.",
    subscriptionCancelCopy: "Pause, skip or cancel anytime.",
  ...
  de: {
    ...
    subscriptionPriceFrequency: "/ 6 Wochen",
    subscriptionRefillCopy: "Wir schicken dir dein Nachfüll-Set automatisch alle 6 Wochen.",
    subscriptionCancelCopy: "Jederzeit pausieren, überspringen oder kündigen.",
