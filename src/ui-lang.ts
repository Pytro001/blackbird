...
const copy = {
  en: {
    ...
    subscriptionPriceFrequency: "/ month",
    subscriptionRefillCopy: "",
    subscriptionCancelCopy: "Pause or cancel at any time and free refill every 6 weeks",
    purchaseDeliveryCopy: "Instant delivery within 6 hours in Germany",
    toggleToSubscriptionAria: "Switch to subscription",
    toggleToPurchaseAria: "Switch to one-time purchase",
  ...
  de: {
    ...
    subscriptionPriceFrequency: "/ Monat",
    subscriptionRefillCopy: "Kostenlose Nachfüllung alle 6 Wochen.",
    subscriptionCancelCopy: "Jederzeit pausieren oder kündigen.",
    purchaseDeliveryCopy: "Sofortlieferung innerhalb von 6 Stunden in Deutschland",
    toggleToSubscriptionAria: "Zum Abo wechseln",
    toggleToPurchaseAria: "Zu Einmalkauf wechseln",
